...
class EventEmitterTest extends UnitTestCase
{
    ...
    public function testOn()
    {
        ...
        $this->assertSame([$this->spyA, $this->spyC, $this->spyA], $this->emitter->listeners('eventA'));
        $this->assertSame([$this->spyB, $this->spyD], $this->emitter->listeners('eventB'));
    }
    ...
    public function testRemoveListener()
    {
        ...
        $this->assertSame([$this->spyA, $this->spyB, $this->spyA], $this->emitter->listeners('eventA'));
        $this->assertSame([$this->spyA], $this->emitter->listeners('eventB'));

        $this->emitter->removeListener('eventA', $this->spyA);

        $this->assertSame([$this->spyB, $this->spyA], $this->emitter->listeners('eventA'));
        $this->assertSame([$this->spyA], $this->emitter->listeners('eventB'));

        $this->emitter->removeListener('eventA', $this->spyA);

        $this->assertSame([$this->spyB], $this->emitter->listeners('eventA'));
        $this->assertSame([$this->spyA], $this->emitter->listeners('eventB'));
    ...
    public function testRemoveAllListenersWithEvent()
    {
        ...
        $this->assertSame([], $this->emitter->listeners('eventA'));
        $this->assertSame([$this->spyA], $this->emitter->listeners('eventB'));
    }
    ...
    public function testRemoveAllListenersWithoutEvent()
    {
        ...
        $this->assertSame([], $this->emitter->listeners('eventA'));
        $this->assertSame([], $this->emitter->listeners('eventB'));
    }
