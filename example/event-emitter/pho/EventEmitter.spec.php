...
pho\describe('EventEmitter', function () {
    ...
    pho\describe('on()', function () {
        pho\it('adds listeners to the correct events', function () {
            ...
            pho\expect($this->emitter->listeners('eventA'))->toBe([$this->spyA, $this->spyC, $this->spyA]);
            pho\expect($this->emitter->listeners('eventB'))->toBe([$this->spyB, $this->spyD]);
        });
    });
    ...
    pho\describe('removeListener()', function () {
        pho\it('removes listeners from the correct events', function () {
            ...
            pho\expect($this->emitter->listeners('eventA'))->toBe([$this->spyA, $this->spyB, $this->spyA]);
            pho\expect($this->emitter->listeners('eventB'))->toBe([$this->spyA]);

            $this->emitter->removeListener('eventA', $this->spyA);

            pho\expect($this->emitter->listeners('eventA'))->toBe([$this->spyB, $this->spyA]);
            pho\expect($this->emitter->listeners('eventB'))->toBe([$this->spyA]);

            $this->emitter->removeListener('eventA', $this->spyA);

            pho\expect($this->emitter->listeners('eventA'))->toBe([$this->spyB]);
            pho\expect($this->emitter->listeners('eventB'))->toBe([$this->spyA]);
    ...
    pho\describe('removeAllListeners()', function () {
        pho\it('removes all listeners from a specific event', function () {
            ...
            pho\expect($this->emitter->listeners('eventA'))->toBe([]);
            pho\expect($this->emitter->listeners('eventB'))->toBe([$this->spyA]);
        });
        ...
        pho\it('removes all listeners from all events', function () {
            ...
            pho\expect($this->emitter->listeners('eventA'))->toBe([]);
            pho\expect($this->emitter->listeners('eventB'))->toBe([]);
        });
    });
